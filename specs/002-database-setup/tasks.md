...
- [X] T035 Run `pnpm typecheck` and confirm zero errors across the entire codebase — all new collections, access functions, hooks, and type imports must compile cleanly
